...
- Adds `Folders` to the correct namespace

---

## [1.2.1] - 2025-08-25
### Gist URLs fixes
- Uses gist URLs that point to the most recent version instead of specific ones.

---

## [1.2.0] - 2025-08-24
### Adds non-LFS .gitattributes option and removes "fetch all of the above" method
- Adds "Fetch non-LFS .gitattributes" menu item.
- Renames "Fetch .gitattributes" to "Fetch LFS .gitattributes".
- Removes "all of the above" menu item.

---

## [1.1.7] - 2025-08-03
### Minor folder structure adjustments
- Uses `Code` instead of `Scripts`.
...
## [1.1.2] - 2025-06-06
### Fixes minor bugs
- Updates gist URL for fetching `.gitignore`.

---

## [1.1.1] - 2025-05-13
### Fixes dependency issue.
- Fixes a dependency issue caused by Unity not allowing git dependencies in package.json.
...
- Changes the following name for accuracy:
